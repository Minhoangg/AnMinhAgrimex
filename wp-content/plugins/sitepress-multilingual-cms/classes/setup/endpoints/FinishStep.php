...
use WPML_All_Language_Pairs;
use WPML_Config;
use WPML_Language_Pair_Records;
use WPML_LS_Dependencies_Factory;
use WPML_TM_Wizard_Options;
use WPML_Translation_Manager_Records;
use WPML_Translator_Records;
use WPML_Translator_Role;
