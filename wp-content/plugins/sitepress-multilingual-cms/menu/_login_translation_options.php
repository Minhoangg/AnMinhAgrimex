...
<div class="wpml-section" id="ml-content-setup-sec-wp-login">
	...
	<div class="wpml-section-header">
		<h3><?php use WPML\UrlHandling\WPLoginUrlConverter;

            esc_html_e( 'Login and registration pages', 'sitepress' ); ?></h3>
	</div>
			...
			<p>
				<label>
					<input type="checkbox" id="login_page_translation"
						...
						<?php checked( get_option( WPLoginUrlConverter::SETTINGS_KEY, false ) ); ?>
						   value="1"/>
