...
use WPML\PB\Elementor\Config\Factory;
use WPML\PB\Elementor\Hooks\DynamicElements;
use WPML\PB\Elementor\Hooks\Editor;
use WPML\PB\Elementor\Hooks\Frontend;
use WPML\PB\Elementor\Hooks\GutenbergCleanup;
use WPML\PB\Elementor\Hooks\LandingPages;
use WPML\PB\Elementor\Hooks\WordPressWidgets;
use WPML\PB\Elementor\LanguageSwitcher\LanguageSwitcher;
	...
	public function create() {
		...
		$action_filter_loader->load(
			array(
				...
				DynamicElements::class,
				GutenbergCleanup::class,
				Frontend::class,
				Factory::class,
				LandingPages::class,
				Editor::class,
				WordPressWidgets::class,
