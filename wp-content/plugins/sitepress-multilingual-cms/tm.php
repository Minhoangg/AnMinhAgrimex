...
use WPML\TM\ATE\Factories\Proxy;
use WPML\TM\ATE\Hooks\JobActionsFactory;
use WPML\TM\ATE\Hooks\ReturnedJobActionsFactory;
use WPML\TM\ATE\Loader;
use WPML\TM\ATE\Review\ApplyJob;
use WPML\TM\ATE\Review\ReviewCompletedNotice;
use WPML\TM\ATE\Review\ReviewTranslation;
use WPML\TM\ATE\Sitekey\Sync;
use WPML\TM\ATE\StatusIcons;
use WPML\TM\AutomaticTranslation\Actions\ActionsFactory;
use WPML\TM\Container\Config;
use WPML\TM\Editor\ManualJobCreationErrorNotice;
use WPML\TM\Jobs\ExtraFieldDataInEditorFactory;
use WPML\TM\Menu\TranslationServices\ActivationAjaxFactory;
use WPML\TM\Menu\TranslationServices\AuthenticationAjaxFactory;
use WPML\TM\Menu\TranslationServices\Resources;
...
use WPML\TM\REST\FactoryLoader;
use WPML\TM\Settings\CustomFieldChangeDetector;
use WPML\TM\Troubleshooting\ResetPreferredTranslationService;
use WPML\TM\Troubleshooting\SynchronizeSourceIdOfATEJobs\TriggerSynchronization;
use WPML\TranslateLinkTargets\Hooks;
use function WPML\Container\delegate;
...
function wpml_tm_load( $sitepress = null ) {
	...
	$global_actions = [
		...
		ReviewTranslation::class,
		JobActionsFactory::class,
	...
	if ( $is_backend ) {
		$actions = [
			...
			Resources::class,
			ActivationAjaxFactory::class,
			AuthenticationAjaxFactory::class,
			RefreshServicesFactory::class,
			...
			ExtraFieldDataInEditorFactory::class,
			Sync::class,
			ReviewCompletedNotice::class,
			CustomFieldChangeDetector::class,
		];
		...
		$ams_ate_actions = [
			...
			ReturnedJobActionsFactory::class,
			ReportAjax::class,
			AteLockNotice::class,
			Loader::class,
			ApplyJob::class,
			...
			StatusIcons::class,
			ManualJobCreationErrorNotice::class
		];
