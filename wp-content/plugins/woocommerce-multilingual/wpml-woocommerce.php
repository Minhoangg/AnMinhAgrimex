...
use WCML\AdminNotices\CachePlugins;
use WCML\AdminNotices\MultiCurrencyMissing;
use WCML\AdminNotices\Review;
use WCML\API\VendorAddon\Hooks;
use WCML\Container\Config;
use WCML\Multicurrency\Analytics\Export;
use WCML\Multicurrency\Analytics\Factory;
use WCML\MultiCurrency\GeolocationBackendHooks;
use WCML\MultiCurrency\GeolocationFrontendHooks;
use WCML\Multicurrency\Shipping\ShippingHooksFactory;
use WCML\Reports\Categories\Query;
use WCML\Setup\BeforeHooks;
...
function wcml_loader() {
	...
	share( Config::getSharedInstances() );
	...
	$loaders = [
		...
		GeolocationFrontendHooks::class,
		GeolocationBackendHooks::class,
		Query::class,
		\WCML\Reports\Orders\Factory::class,
		Factory::class,
		Export::class,
		BeforeHooks::class,
		MultiCurrencyMissing::class,
