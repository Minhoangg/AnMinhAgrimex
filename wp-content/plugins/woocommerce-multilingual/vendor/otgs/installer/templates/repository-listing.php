<?php use OTGS\Installer\Templates\Repository\Expired;
use OTGS\Installer\Templates\Repository\LegacyFree;
use OTGS\Installer\Templates\Repository\Refunded;
use OTGS\Installer\Templates\Repository\Register;
use OTGS\Installer\Templates\Repository\Registered;
use function OTGS\Installer\FP\partial;

if ( (!$this->repository_has_subscription( $repository_id ) && $match = $this->get_matching_cp( $repository )) && $match['exp'] ): ?>
...
<?php
$getWhenSubscriptionExpires = function ( $repository ) {
	return $repository['subscription']['data']->expires;
};
$model                      = (object) [
	...
	'whenExpires'            => partial( $getWhenSubscriptionExpires, $repository ),
	'expired'                => false,
