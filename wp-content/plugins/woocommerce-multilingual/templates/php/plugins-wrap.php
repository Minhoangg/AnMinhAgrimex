...
<div class="wrap">
    ...
    <nav class="wcml-tabs wpml-tabs" style="display:table;margin-top:30px;">
        <a class="nav-tab nav-tab-active wcml-required-plugins-tab"
           href="<?php echo esc_attr( $model->link_url ); ?>"><?php echo wp_kses_post( $model->strings->required ); ?></a>
    </nav>
            ...
            <div class="wcml-section-header">
                <h3>
                    ...
                    <i class="otgs-ico-help wcml-tip"
                       data-tip="<?php echo esc_attr( $model->strings->depends ); ?>"> </i>
                </h3>
            </div>
            <div class="wcml-section-content wcml-section-content-wide">
                <ul>
                      ...
                      <li>
                          ...
                          <a href="<?php echo esc_attr( $model->install_wpml_link ); ?>"
                             target="_blank"><?php echo wp_kses_post( $model->strings->get_wpml ); ?></a>
                      </li>
										<?php
									}
                      ...
                      <li>
                          ...
                          <a href="<?php echo esc_attr( $model->install_wpml_link ); ?>"
                             target="_blank"><?php echo wp_kses_post( $model->strings->get_wpml_tm ); ?></a>
                      </li>
										<?php
									}
                      ...
                      <li>
                          ...
                          <a href="<?php echo esc_attr( $model->install_wpml_link ); ?>"
                             target="_blank"><?php echo wp_kses_post( $model->strings->get_wpml_st ); ?></a>
                      </li>
										<?php
									}
                      ...
                      <li>
                          ...
                          <a href="<?php echo esc_attr( $model->wc_link ); ?>"
                             target="_blank"><?php echo wp_kses_post( $model->strings->download_wc ); ?></a>
                      </li>
										<?php
