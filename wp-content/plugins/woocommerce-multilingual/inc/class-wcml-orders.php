...
class WCML_Orders {
	...
	public function get_filtered_comments( $comments ) {
		...
		$translateInWoocommerce = partialRight( 'translate', 'woocommerce' );
	...
	public function woocommerce_order_get_items( $items, $order ) {
		...
		$translate_order_items = is_admin() || is_view_order_page() || is_order_received_page() || Functions::isRestApiRequest();
		/**
